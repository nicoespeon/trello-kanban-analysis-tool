...
test('CumulativeFlowDiagram#consolidateActions', (assert) => {
  const expected = [
    {
      date: '2016-02-03',
      content: [
...
test('parseCurrentStatus', (assert) => {
  ...
  assert.looseEquals(
    parseCurrentStatus('2016-03-18', data),
    expected,
    'should parse given list and date into current status'
  );
  assert.looseEquals(
    parseCurrentStatus('2016-03-18')(data),
    expected,
...
test('parseActions', (assert) => {
  ...
  assert.looseEquals(
    parseActions('2016-03-12', trelloLists, trelloActions),
    expected,
    'should correctly parse Trello actions'
  );
  assert.looseEquals(
    parseActions('2016-03-12')(trelloLists, trelloActions),
    expected,
  ...
  assert.looseEquals(
    parseActions('2016-03-12', trelloLists, []),
    expectedWithEmptyActions,
    'should handle empty actions'
  );
  assert.end();
});
